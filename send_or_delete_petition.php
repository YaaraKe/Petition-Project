...
<a data-toggle="tooltip" title="You can send Email to all supporters of your petition" href="email_to_signatories.php?id=<?php echo $row['id_petition']; ?>" class="btn btn-outline-primary"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-check" viewBox="0 0 16 16">
