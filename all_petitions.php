...
<body>
    ...
    <section>
        <form action="" method="POST" class="search-box">
            ...
            <button id="submit" name="submit2" type="submit"> <svg id="icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
