...
<body>
    ...
    <main class="container">
        <div class="row">
            ...
            $sql = "SELECT DISTINCT * FROM shop WHERE id=2  LIMIT 1";
            ...
            <div class="col-md-4">
                <div>
                    ...
                    ?>
                        ...
                        <div>
                            <p id="price2"><?php echo $row['cost']; ?>₪</p>
                        </div>
                    <?php } ?>
                    ...
                    <script type="text/javascript">
                        ...
                        function updateModified(e) {
                            ...
                            if (element.innerHTML == "success") {
                                <?php
                                $sql1 = "UPDATE shop SET status=status-1 WHERE id=2 LIMIT 1";
    ...
    <br>
    <script async src="https://pay.google.com/gp/p/js/pay.js" onload="onGooglePayLoaded(document.getElementById('price2').innerHTML.replace('₪', ''))"></script>
